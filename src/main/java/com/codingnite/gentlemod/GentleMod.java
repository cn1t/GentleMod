package com.codingnite.gentlemod;
...
@Mod(GentleMod.MOD_ID)
public class GentleMod
{
    public static final String MOD_ID = "gentlemod";
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo("gentlemod", "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
